...
addColumnIfMissing('discount_codes', 'expira', 'TEXT');
addColumnIfMissing('discount_codes', 'generado_por_ruleta', 'INTEGER DEFAULT 0');
...
const DEFAULT_SETTINGS = {
  ...
  carrito_banner_link: '',
  confirmacion_imagen: '',
  banners_intercalados: [],
  ruleta: {
    activa: false,
    boton_texto: 'Gana descuentos',
    eyebrow: 'Solo por hoy',
    titulo: '¡Gira y llévate tu descuento!',
    pie_texto: 'El código aplica una sola vez por compra.',
    ...
    color_texto: '#FFF8F0',
    segmentos: [
      { texto: '0%', color: '#2A0944', premio: false, porcentaje: 0 },
      { texto: '15%', color: '#FF2D6F', premio: true, porcentaje: 15 },
      { texto: '5%', color: '#6A2C91', premio: true, porcentaje: 5 },
      { texto: '0%', color: '#3D1259', premio: false, porcentaje: 0 },
      { texto: '10%', color: '#E0195A', premio: true, porcentaje: 10 }
    ]
  },
