...
const DEFAULT_SETTINGS = {
  ...
  ruleta: {
    ...
    color_texto: '#FFF8F0',
    segmentos: [
      { texto: '0%', color: '#2A0944', premio: false, codigo: '' },
      { texto: '15%', color: '#FF2D6F', premio: true, codigo: 'BIENVENIDA15' },
      { texto: '5%', color: '#6A2C91', premio: true, codigo: 'BIENVENIDA5' },
      { texto: '0%', color: '#3D1259', premio: false, codigo: '' },
      { texto: '10%', color: '#E0195A', premio: true, codigo: 'BIENVENIDA10' }
    ]
  },
